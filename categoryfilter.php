...
$query2="select * from tbl_product where pcategory='$ctid'";
$result2=mysqli_query($connect,$query2);
$query3="select * from tbl_category where cate_id='$ctid'";
          ...
          <div class="card shadow ">
            <div class="card-header border-0">
              <h3 class="mb-0 text-uppercase"data-aos="fade-up"><span class="text-danger display-4"><?php if($row3=mysqli_fetch_array($result3)){
              	echo $row3['cname'];
              } ?></span><span style="font-size: 13px;"> Category Products</span></h3>
              <a href="category.php" class="float-right"><button type="button"data-aos="fade-left" class="btn text-white bg-gradient-danger mr-4" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo">Back</button></a>
            </div>
              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="code/productdelete.php?pid=<?php echo $row2['pro_id'];?>"><button class="btn text-white"><i class="fa fa-trash"style="font-size: 19px"></button></a></td>
                  </tr></tbody>
                    <?php } 
                    if ($row2['pquantity']==0) {?>
