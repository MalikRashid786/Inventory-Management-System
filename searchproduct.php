...
$query2="select * from tbl_product where pro_id='$ser_id'";
      ...
      <div class="row">
        <div class="col mb-5" style="margin-top: 150px;">
          <div class="card shadow ">
            ...
            <p class="mb-0"data-aos="fade-up" style="font-size: 19px;font-weight: bold;">Search<span class="text-danger display-4"> Product</span></p>
            </div>
              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                  ...
                  <tr  data-aos="fade-right">
                    ...
                    <td><a href="code/productdelete.php?pid=<?php echo $row2['pro_id'];?>"><button class="btn btn-danger"><i class="fa fa-trash"style="font-size: 19px"></button></a></td>
                  </tr>
                   <?php } 
                  ...
                  <tr>
                    ...
                    <td><a href="code/productdelete.php?pid=<?php echo $row2['pro_id'];?>"><button class="btn btn-danger"><i class="fa fa-trash"style="font-size: 19px"></i></button></a></td>
                  </tr></tbody>
                    <?php } 
                    if ($row2['pquantity']==0) {?>
